...
ROWS = [
    ...
    ("", ""),
    ("Built", "Project QUANTEX — AI technical support"),
    ("", "multilingual diagnostics · technician matching"),
    ("Also", "AI agents · automation · ML systems"),
    ("", "startups · experiments · questionable ideas"),
    ("", ""),
    ("Stack", "Python · C++ · Java · Machine Learning"),
    ("Tools", "GitHub · FastAPI · Ollama · AWS"),
    ("Focus", "AI/ML · intelligent automation"),
    ("", ""),
    ("Education", "BSc Data Science @ IIT Madras"),
]
